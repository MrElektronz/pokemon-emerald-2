...
static const struct TrainerMonItemCustomMoves sParty_GruntPetalburgWoods[] = {
    ...
    .moves = {MOVE_SUNNY_DAY, MOVE_TAUNT, MOVE_BITE, MOVE_IRON_TAIL}
    },
    {
    .iv = 120,
    .lvl = 9,
    ...
    .moves = {MOVE_INCINERATE, MOVE_DOUBLE_TEAM, MOVE_GRASS_KNOT, MOVE_WILL_O_WISP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FURY_CUTTER, MOVE_SMACK_DOWN, MOVE_SAND_ATTACK, MOVE_SAND_TOMB}
    },
    {
    .iv = 100,
    .lvl = 12,
    ...
    .moves = {MOVE_ROCK_POLISH, MOVE_PROTECT, MOVE_ROCK_THROW, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .lvl = 10,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_TACKLE, MOVE_ROCK_SMASH, MOVE_DEFENSE_CURL, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lilith[] = {
    ...
    .species = SPECIES_FALINKS,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_BRICK_BREAK, MOVE_POISON_JAB, MOVE_BODY_PRESS, MOVE_PROTECT}
    },
    {
    .iv = 150,
    .lvl = 14,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_BRICK_BREAK, MOVE_SWIFT, MOVE_LOW_SWEEP, MOVE_MEGA_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lyle[] = {
    ...
    .moves = {MOVE_ABSORB, MOVE_BODY_SLAM, MOVE_THUNDER_PUNCH, MOVE_BULLET_SEED}
    }
};
